...
| **Canlı GPS haritası** | Leaflet; **assets/ içinde yerel** leaflet.js/css. Karanlık / topo / uydu katmanı seçilebilir, yer istasyonu konumu işaretli, 2 Hz throttle. |
...
| [assets/](assets/) | Yerel Leaflet js/css + marker ikonları. |
...
- [ ] **Offline harita** — tile'lar hâlâ CartoDB/Esri CDN'den geliyor; sahada
      internet yoksa harita boş kalır. Leaflet js/css yerelleştirildi, tile
      fallback gerekli.
